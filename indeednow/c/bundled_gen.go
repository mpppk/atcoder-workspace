...
//go:generate bundle -o indeednow/c/bundled_gen.go -pkg main -dst github.com/mpppk/atcoder/indeednow/c github.com/mpppk/atcoder/gen
...
func lib_getZeroValue(v interface{}) interface{} {
	switch v.(type) {
